        ...
        public static Simulation GetSimulation()
        {
            Floors floors = new(
                new List<Floor>()
                {
                    ...
                    //new Floor(29, 250.ToCentimeters()),
                    //new Floor(30, 250.ToCentimeters()),
                    //new Floor(31, 250.ToCentimeters()),
                    //new Floor(32, 250.ToCentimeters()),
                    //new Floor(33, 250.ToCentimeters()),
                    //new Floor(34, 250.ToCentimeters()),
                    //new Floor(35, 250.ToCentimeters()),
                    //new Floor(36, 250.ToCentimeters()),
                    //new Floor(37, 250.ToCentimeters()),
                    //new Floor(38, 250.ToCentimeters()),
                    //new Floor(39, 250.ToCentimeters()),
                },
                10.ToCentimeters()
            );
