...
namespace UI
{
    ...
    public class BasicRequestEventViewModel : ViewModelBase<BasicRequestEvent>, IEventViewModel
    {
        public FloorViewModel EventLocation { get; private set; }
        public FloorViewModel Destination { get; private set; }

        public BasicRequestEventViewModel(BasicRequestEvent model) : base(model)
        {
